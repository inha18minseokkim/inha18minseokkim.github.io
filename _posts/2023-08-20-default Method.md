...
클래스가 항상 이김
클래스가 없으면 더 자식인 인터페이스가 이김(더 구체적인 인터페이스)
그럼에도 안되면 명시적으로 디폴트 메서드 오버라이드 후 호출
...
[Default 메서드 문제 - 접근 문제(20230925, java 19)]({% post_url 2023-09-25-Default 메서드 문제 - 접근 문제(20230925, java 19) %})
