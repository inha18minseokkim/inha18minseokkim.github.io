---
title: Reactor에서 MDC가 안 찍히는 이유 — Slf4JEventListener scope 문제
date: 2026-08-26
tags:
  - Spring
  - WebFlux
...
[499 트레이싱 작업]({% post_url 2026-08-20-stock-mediation-499-part4 %}) 중에 OTel java agent를 걷어내고 Micrometer 기반으로 갈아타는 과정에서 traceId/spanId가 로그에 안 찍히는 문제를 만났다. 원인이랑 해결 과정 정리.
