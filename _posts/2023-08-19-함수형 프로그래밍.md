...
“결과 자료구조를 바꾸지 말자”
[람다/함수형 인터페이스]({% post_url 2023-08-19-람다함수형 인터페이스 %})
[Combinator]({% post_url 2023-08-19-Combinator %})
[Lazy init]({% post_url 2023-08-19-Lazy init %})
...
![](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/b9ce1850-7a20-4400-9ebe-b2ab3d1e7aa8/Untitled.png)
...
[커링]({% post_url 2023-08-18-커링 %})

[스트림]({% post_url 2023-08-19-스트림 %})
[함수형 인터페이스 추정]({% post_url 2023-09-07-함수형 인터페이스 추정 %})