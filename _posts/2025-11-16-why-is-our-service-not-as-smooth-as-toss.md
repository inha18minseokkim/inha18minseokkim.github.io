...
---
개발 관련 내용 정리.
![이미지](/assets/images/Pasted%20image%2020260301222323.png)


![이미지](/assets/images/Pasted%20image%2020260301222330.png)
...
3. 게임가입 안되어있으면 동의서 받고 가입시키고 다시 돌아가서 조회 진행합니다
...
그러니깐 동작 기반으로 api를 호출하고 채널 개발자가 개발하면 된다고 생각했는데 MPA 구조라서 api를 호출하려면 해당 화면을 띄워야 함, 만약 그렇지 않다면 메인 화면에서 모든 api를 불필요하지는 않지만 좀 불필요한 느낌으로 중복호출 해야하니깐 이런 서비스들을 부드럽게 구현하려면 채널 개발자가 많은 고생을 하겠다..

### 그럼 비상장주식은 어떻게 구현한거지

<video width="100%" controls>
  <source src="/assets/videos/KakaoTalk_Video_2025-11-17-21-11-20.mp4" type="video/mp4">
</video>
