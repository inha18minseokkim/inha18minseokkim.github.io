...
category:
  ...
  - MSA표준
---
S3와 Logback을 활용한 로그 저장 구현 정리.
# 현재 검토중이었던 버전

![이미지](/assets/images/Pasted%20image%2020260301000159.png)
...
![이미지](/assets/images/Pasted%20image%2020260301000209.png)
...
![이미지](/assets/images/Pasted%20image%2020260301000219.png)
...
이 논의는 거래이력 로깅 구조 개선의 일환으로 진행되었다:

- [DB Sync 개선 - 거래이력 로깅 병목 해결]({% post_url 2025-07-29-db-sync-improvement %}) - 현재 RDB 로깅 구조의 문제점 및 개선 방향
